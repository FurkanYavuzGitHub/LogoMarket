<%@ Page Title="" Language="C#" MasterPageFile="~/Ziyaretci.master" AutoEventWireup="true" CodeFile="teklifler.aspx.cs" Inherits="index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="icerik" Runat="Server">
    <asp:Table ID="tekliflertable" runat="server" Height="50px" Width="1200px" 
